...
export default function OtherCertifictes() {
  ...
  const getOtherCertificates = async () => {
    ...
    fetch(API_URL4010 + "school_getCerticates", requestOptions)
  ...
  const addCertificate = async () => {
    ...
    if (pictures1?.some((file) => file?.name !== '')) {
      ...
      // Make API call
      fetch(API_URL4010 + "school_addCerticates", {
        method: 'POST',
        headers: myHeaders,
        body: formdata,
        redirect: 'follow'
