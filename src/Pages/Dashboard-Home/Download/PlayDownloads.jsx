...
export default function PlayDownloads() {
...
// console.log(vidPath+chunkdatavedio1[0]?.vid_name,'chunkdatavedio1[0]?.vid_name');
  return (
    <div className='overall-container-ply-dnld'>
       <Toaster
        toastOptions={{
          style: { backgroundColor: '#222122', color: '#fff' },
        }}
      />
     <div  className='video-title-ply-dnld'>
        <PageTitle title={videos.videotitle}/>
        </div>
        <div className='top-items-continer-ply-dnld'>
...
<div  className='video-main-container-ply-dnld'>
  <div className='left-container-ply-dnld'>
        <div className='video-player-ply-dnld'
...
{/* )} */}
  ...
  backgroundSize: 'cover',
      ...
      >
        ...
        {/* <Player
            ...
            <div className='video-controls-container-ply-dnld'>
              ...
              <div className='video-controls-right-ply-dnld'>
                ...
                <div className='video-control-4-ply-dnld' onClick={toggleSettings} style={{display: showControls ? 'flex' : 'none'}}>
                  <img src='/assets/videocontrol-3.png' loading="lazy" alt="" />
                </div>
                {showSettings && !showAudioSettings && !isPickerOpen && (
                  <div className='video-settings-ply-dnld' >
        ...
        <div className="small-main-container-ply-dnld">
  <div className="small-div-1-ply-dnld">
    <div className="small-icon-1-ply-dnld">
      <img src='/assets/play-button.png'
      style={{ filter: "invert(100%)" }}
       loading="lazy" alt="" />
    {/* <div className="small-text-1-ply"> */}
    </div>{`${Math.floor(Math.round(Number(newDuration).toFixed(2)) / 60)}:${Math.round(Number(newDuration).toFixed(2)) % 60 < 10 ? '0' : ''}${Math.round(Number(newDuration).toFixed(2)) % 60}`}min</div>
  {/* </div> */}

 


  <div className='new-ffav-ply-dnld' style={{float:'right'}}>
  {/* <div className="dropdown-icon">
      <img
      style={{filter:darkMode ? 'invert(100%)':'invert(0%)'}}
        src={require('../../Assets/vidcategory.png')}
        alt="Menu"
        className="icon"
      />
    ...
    <div className="fav-icon-ply-dnld">
      {/* <img
        style={{filter:darkMode?'invert(100%)':'invert(0%)'}}
   ...
   value={progress} text={`${progress}%`} />
        ...
        <div className='video-description-ply-dnld'>
        <div className='video-disc-ply-dnld'>{videos.videotitle}</div>
        <div className='video-para-ply-dnld'>{videos.videodescription}</div>
        </div>
        </div>
