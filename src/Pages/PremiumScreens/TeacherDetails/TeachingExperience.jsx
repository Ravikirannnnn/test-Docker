...
export default function TeachingExperience() {
  ...
  const getTeacherExperience = async () => {
    ...
    fetch(API_URL4010 + "school_getTeachingExperience", requestOptions)
  ...
  return (
    ...
    {Designation?.map((item, index) => (
        ...
        <span className='teaching-btn' style={{marginTop:'20px'}} onClick={()=>navigate('/ExperienceForm')}>Add Another</span>
